...
import { changeUserRol } from '../../app/(dashsettings)/actions/actions'

function UsersApplyButton({ id, value }) {
  return (
    <form action={async () => await changeUserRol(id, value)}>
      <button
        type="submit"
...
export default UsersApplyButton

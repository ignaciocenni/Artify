...
export const FiltersCompounent = () => {
        ...
        <div className='w-80 h-72 pt-5 pl-5'>
            ...
            >
                ...
                <span className="border-l p-2 hover:bg-gray-100">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox='0 0 24 24' xmlns="https://file.rendit.io/n/0aXnru4DI8UuSC0ZygNs.svg">
            ...
            <div className="flex flex-row justify-between relative  items-center">
                <input className="w-28 h-9" name='min' placeholder='Min' value={filters.min} onChange={handlerImput} />
                <h1> A </h1>
                <input className="w-28 h-9" name='max' placeholder='Max' value={filters.max} onChange={handlerImput}/>
            </div>

            <div className="overflow-hidden bg-[#0a0a0a] flex flex-col justify-center relative w-20 h-11 items-center rounded-lg z-0">
                <button className="text-xs font-['Inter'] font-bold text-white relative w-1/2" onClick={clickHandler}>
                    Aplicar
                </button>
            </div>
        </div>
